...
import sys
#将 scripts 文件夹添加到 Python 模块搜索路径
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../../emclient-android/scripts')))
from convert_to_agora_rules import UPDATE_dict,UPDATE_second_dict
...
#需要替换的字符串map
extra_strings_map = UPDATE_dict.copy()
extra_strings_map.update(UPDATE_second_dict)
